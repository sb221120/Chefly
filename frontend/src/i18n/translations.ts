...
export const translations = {
  UK: {
    ...
    profile_unlimited_scans: 'Необмежені AI сканування',
    profile_valid_until: 'Дійсний до Жовтень 2026',
  ...
  RU: {
    ...
    profile_premium_member: 'PREMIUM MEMBER',
    profile_unlimited_scans: 'Неограниченные AI сканирования',
    profile_valid_until: 'Действителен до Октябрь 2026',
...
export const t = (key: keyof typeof translations['UK'], lang: Language): string => {
